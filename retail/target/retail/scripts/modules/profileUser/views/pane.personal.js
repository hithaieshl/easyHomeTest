...
define([
    ...
    // Template
    ,'requirejs-text!modules/profileUser/templates/personal.html'
    ...
    ,'helpers/backbone/validation'
        ...
        var Personal = Pane.extend({
            ...
            ,bindings: {
                ...
                ,'[name=hasCoapplicant]':           'hasCoapplicant'
                //,'[name=nativeStatusNumber]':       'nativeStatusNumber'
            }
            ,onCoapplicantChange: function(event) {
                var $target = $(event.target);
                var value = $target.val();
                this.notifyCoapplicantChange(this.model, value);
            }
            ,notifyCoapplicantChange: function(model, value) {
                value = value === 'true' ? true : value === 'false' ? false : value;
                Eva.trigger('profile:coapplicant:change', value);
            }
            ...
            ,initialize: function(attributes, options) {
                ...
                this.setMaxDate();
                this.model.on('change:hasCoapplicant', this.notifyCoapplicantChange);
				
				Eva.trigger('profile:coapplicant:change', this.model.get('hasCoapplicant'));
            }
        });
